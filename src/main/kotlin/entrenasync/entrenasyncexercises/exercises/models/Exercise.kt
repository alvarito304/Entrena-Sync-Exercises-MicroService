...
enum class BodyPart {
    NECK, CHEST, FRONT_DELT_AND_BICEPS, UPPER_CORE, FOREARM, MID_CORE, LOWER_CORE, HAND, QUADRICEPS_AND_ADDUCTORS, KNEE, TIBIALIS, FOOT,
    TRAPS, UPPER_BACK, REAR_DELT_AND_TRICEPS, ELBOW, LOWER_BACK, GLUTEUS, HAMSTRING, CALVES
}
